...
class Global{
  ...
  Point[] points = new Point[1000000]; Segment[] segments = new Segment[1000000]; Vector[] vectors = new Vector[1000000]; Line[] lines = new Line[1000000]; Polygon[] polygons = new Polygon[100000]; Polyline[] polylines = new Polyline[100000]; Plane[] planes = new Plane[100000]; Face[] faces = new Face[100000]; Particle[] particles = new Particle[1000000]; Collider[] colliders = new Collider[100000];
  Polygon stage;
  Global(){
    npoints = nsegments = nvectors = nlines = npolygons = npolylines = nplanes = nfaces = nparticles = 0; ncolliders = 0;
  }
  void init(){
